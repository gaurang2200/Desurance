...
contract Desurance is ERC20{
    ...
    function addUser() public payable{
        require(msg.value > subscriptionFees, "Insufficient Funds sent");
       // require(_nominee != address(0));
        User memory newuser;

        newuser.UserRegistered = true;
        newuser.userStartTime = block.timestamp;
        // newuser.ERCTokens = new address[
        //     "0x7D1AfA7B718fb893dB30A3aBc0Cfc608AaCfeBB0", 
        //     "0xdAC17F958D2ee523a2206206994597C13D831ec7", 
        //     "0xba2ae424d960c26247dd6c32edc70b295c744c43"
        // ](3);
        // newuser.balances = new uint256[1,1,1];
    ...
    function addNominee(address _nominee) public {
        require(_nominee != address(0), "Nominee Address cannot be Zero Address");
    ...
    function approveOperator(address[] memory tokenAddress) public {
        ...
        uint x = usersIndex[msg.sender];
        require(x >= 0, "User not registered");
        ...
        for(uint i=0; i < len ; i++){
            ...
            final1 = approve(moderator, balance);
    ...
    function transferFundsToNominee() public{
        require(msg.sender == moderator, "The caller is not the moderator");
        require(block.timestamp > oneminute, "Not enough time passed");
        ...
        for(uint i=0;i<arrayLength;i++){
            ...
            for(uint j=0;j<balanceLength;j++){
                ...
                transferFrom(usersTransfer[i], finalNominee, balanceNow);
            }
